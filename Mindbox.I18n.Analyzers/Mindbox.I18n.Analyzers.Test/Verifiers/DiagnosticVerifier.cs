...
public abstract partial class DiagnosticVerifier
{
	...
	/// <summary>
	/// Checks each of the actual Diagnostics found and compares them with t
	/// he corresponding DiagnosticResult in the array of expected results.
	/// Diagnostics are considered equal only if the DiagnosticResultLocation,
	/// Id, Severity, and Message of the DiagnosticResult match the actual diagnostic.
	/// </summary>
		...
		params DiagnosticResult[] expectedResults)
	{
		...
		if (expectedCount != actualCount)
		{
			...
			Assert.IsTrue(false,
				string.Format("Mismatch between number of diagnostics returned, " +
				"expected \"{0}\" actual \"{1}\"\r\n\r\nDiagnostics:\r\n{2}\r\n",
		...
		DiagnosticResultLocation expected)
	{
		...
		Assert.IsTrue(
			...
			string.Format("Expected diagnostic to be in file \"{0}\" was " +
				"actually in file \"{1}\"\r\n\r\nDiagnostic:\r\n    {2}\r\n",
		...
		if (actualLinePosition.Line > 0)
		{
			...
			{
				Assert.IsTrue(false,
					string.Format("Expected diagnostic to be on line \"{0}\" " +
						"was actually on line \"{1}\"\r\n\r\nDiagnostic:\r\n    {2}\r\n",
		...
		if (actualLinePosition.Character > 0)
		{
			...
			{
				Assert.IsTrue(false,
					string.Format("Expected diagnostic to start at column \"{0}\" was " +
						"actually at column \"{1}\"\r\n\r\nDiagnostic:\r\n    {2}\r\n",
